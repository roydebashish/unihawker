...
jQuery(function($) {
    ...
    function porto_import_dummy(options) {
        ...
        if (options.import_dummy) {
            var demo = options.demo,
                data = {'action': options.dummy_action, 'process':'import_start', 'demo': demo, 'override_contents': options.override_contents};
            dummy_index = 0;
            dummy_count = 0;
        ...
        $.post(ajaxurl, args, function(response) {
            if (response && /^[\],:{}\s]*$/.test(response.replace(/\\["\\\/bfnrtu]/g, '@').
                ...
                if (response.process != 'complete') {
                    var requests = {'action': args.action};
    ...
    function porto_import_revsliders(options) {
        ...
        if (options.import_dummy) {
            var demo = options.demo,
                data = {'action': 'porto_import_revsliders', 'demo': demo};
            if (options.import_options) {
    ...
    function porto_import_shortcodes(options) {
        ...
        if (options.import_shortcodes) {
            var demo = options.demo,
                data = {'action': options.dummy_action, 'process':'import_start', 'demo': 'shortcodes'};
    ...
    function porto_import_failed(demo) {
    ...
    jQuery(document).ready(function($) {
        ...
        $('#porto_settings-header-type ul.redux-image-select').append('<li class="classic-demos"></li><li class="ecommerce-demos"></li>');
