...
<?php elseif ( 'side' === $header_type ) : ?>
    ...
    @media (min-width: 992px) {
        ...
        .header-wrapper.header-side-nav #header .searchform button { padding: <?php echo $rtl ? '0 8px 0 9px' : '0 9px 0 8px'; ?>; }
...
<?php endif; ?>
article.post .post-title { color: <?php echo $skinColor ?>; }
...
.post-item .post-date .format { background-color: <?php echo $skinColor ?>; }
