...
add_action('wp_head', 'porto_output_internal_styles', 151);
...
function porto_currency_switcher() {
    ...
    if ( !$porto_settings['wcml-switcher'] && has_nav_menu( 'currency_switcher' ) ) :
        wp_nav_menu(array(
            ...
            'container' => '',
            'menu_class' => 'currency-switcher porto-view-switcher mega-menu show-arrow' . ($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'') . ($porto_settings['menu-sub-effect']?' '.$porto_settings['menu-sub-effect']:''),
            'before' => '',
            'after' => '',
            'depth' => 2,
            'link_before' => '',
    ...
    if ( $porto_settings['wcml-switcher'] && $porto_settings['wcml-switcher-pos'] == '' ) {
        if ( class_exists('WCML_Multi_Currency') ) {
            ...
            ?>
            <ul id="menu-currency-switcher" class="currency-switcher porto-view-switcher mega-menu show-arrow<?php echo ($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'') ?><?php echo ($porto_settings['menu-sub-effect']?' '.$porto_settings['menu-sub-effect']:'') ?>">
	...
	if ( !$result && $porto_settings['wcml-switcher-html'] ) {
		$result = '<ul id="menu-currency-switcher" class="currency-switcher porto-view-switcher mega-menu show-arrow'. ($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'') .'">
...
function porto_view_switcher() {
    ...
    if ( !$porto_settings['wpml-switcher'] && has_nav_menu( 'view_switcher' ) ) :
        wp_nav_menu(array(
            ...
            'container' => '',
            'menu_class' => 'view-switcher porto-view-switcher mega-menu show-arrow' . ($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'') . ($porto_settings['menu-sub-effect']?' '.$porto_settings['menu-sub-effect']:''),
            'before' => '',
            'after' => '',
            'depth' => 2,
            'link_before' => '',
    ...
    if ( $porto_settings['wpml-switcher'] && $porto_settings['wpml-switcher-pos'] == '' ) {
        if ( function_exists('icl_get_languages') ) {
            ...
            if (!empty($languages)) {
                ...
                ?>
                <ul id="menu-view-switcher" class="view-switcher porto-view-switcher mega-menu show-arrow<?php echo ($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'') ?><?php echo ($porto_settings['menu-sub-effect']?' '.$porto_settings['menu-sub-effect']:'') ?>">
	...
	if ( !$result && $porto_settings['wpml-switcher-html'] ) {
		$result = '<ul id="menu-view-switcher" class="view-switcher porto-view-switcher mega-menu show-arrow'.($porto_settings['switcher-effect']?' '.$porto_settings['switcher-effect']:'').'">
                    <li class="menu-item has-sub narrow">
                        <a class="nolink" href="#"><img src="'. porto_uri .'/images/flags/en.png" alt=""> Eng</a>
						<div class="popup">
							<div class="inner">
								<ul class="sub-menu">
									<li class="menu-item"><a href="#"><img src="'. porto_uri .'/images/flags/en.png" alt=""> Eng</a></li>
									<li class="menu-item"><a href="#"><img src="'. porto_uri .'/images/flags/fr.png" alt=""> Frh</a></li>
								</ul>
							</div>
						</div>
                    </li>
...
function porto_mobile_view_switcher() {
    ...
    if ( $porto_settings['wpml-switcher'] && function_exists('icl_get_languages')) {
        ...
        if (!empty($languages)) {
            ...
            ?>
            <ul id="menu-view-switcher" class="view-switcher porto-view-switcher accordion-menu show-arrow">
                <li class="menu-item<?php if ($other_langs) echo ' has-sub' ?> narrow">
                    <a class="nolink" href="#"><?php echo $active_lang ?></a>
                    <?php if ($other_langs) : ?>
                        <span class="arrow"></span>
    ...
    $result = str_replace('&nbsp;', '', ob_get_clean());
    if ( !$result && $porto_settings['wpml-switcher-html'] ) {
        $result = '<ul id="menu-view-switcher" class="view-switcher porto-view-switcher accordion-menu show-arrow">
                    <li class="menu-item has-sub narrow">
                        <a class="nolink" href="#"><img src="'. porto_uri .'/images/flags/en.png" alt=""> English</a>
                        <span class="arrow"></span>
                        <ul class="sub-menu">
...
function porto_output_internal_styles() {

    global $porto_settings;

    echo '<style id="porto-generated-css-output" type="text/css">';
