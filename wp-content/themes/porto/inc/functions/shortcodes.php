...
function porto_load_shortcodes() {
    ...
    if ( function_exists('vc_map') ) {
        ...
        global $pagenow;
        if ( ( $pagenow != 'themes.php' || !isset($_GET['page']) || 'porto_settings' !== $_GET['page'] ) && isset( $porto_settings['speed-optimize-js-composer-shortcodes'] ) && !empty( $porto_settings['speed-optimize-js-composer-shortcodes'] ) ) {
            foreach( $porto_settings['speed-optimize-js-composer-shortcodes'] as $shortcode ) {
