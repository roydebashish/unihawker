            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'color' => '#header, #header .header-main .header-contact, #header .header-main .header-contact *, #header .header-main .header-contact .nav-top > li > a, #header .top-links > li.menu-item:before'
                        )
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'color' => '#mini-cart.minicart-inline .cart-items, #mini-cart .minicart-icon'
                        )
                    ),
                    array(
                    ...
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'border-color' => '#mini-cart.minicart-box'
                        )
                    ),
                    array(
                        ...
                        'type' => 'color',
                        'title' => __('Background Color', 'porto'),
                        'desc' => __('when mini cart type is 2 or 3', 'porto'),
                        'default' => '',
                        'validate' => 'color',
                        'output' => array(
                            'background' => '#mini-cart.minicart-box, #mini-cart.minicart-inline'
                        )
                    ),
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'border-color' => '#mini-cart .cart-popup, #mini-cart .cart-popup:before'
                        ),
                    ),
                    array(
                        'id'=>'1',
                    ...
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'color' => '.main-menu-wrap .menu-right #mini-cart.minicart-inline .cart-items, .main-menu-wrap .menu-right #mini-cart .minicart-icon'
                        )
                    ),
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'color' => '.main-menu-wrap .menu-right #mini-cart .cart-items'
                        )
                    ),
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'border-color' => '.main-menu-wrap .menu-right #mini-cart.minicart-box'
                        )
                    ),
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'background' => '.main-menu-wrap .menu-right #mini-cart.minicart-box, .main-menu-wrap .menu-right #mini-cart.minicart-inline',
                        )
                    ),
                    array(
                        ...
                        'validate' => 'color',
                        'output' => array(
                            'border-color' => '.main-menu-wrap .menu-right #mini-cart .cart-popup, .main-menu-wrap .menu-right #mini-cart .cart-popup:before'
                        )
                    ),
                )
            );
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                "wide_grid" => array('title' => __( 'Wide Grid', 'porto' ), 'img' => porto_options_uri.'/products/wide_grid.jpg'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'lazyload-enable',
                        'type' => 'switch',
                        'title' => __('Lazy Load Images', 'porto'),
                        'desc' => __( 'Enable lazy loading images. Use with caution! Disable this option if you have any compability problems.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    ...
                    array(
                        ...
                        'desc' => __( 'By using this option, you can use visual composer features only what you used for. This will reduce around hundreds of KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    array(
                        'id' => 'speed-optimize-js-composer-shortcodes',
                        'type' => 'select',
                        'title' => __( 'Select Visual Composer shortcodes to remove', 'porto' ),
                        'desc' => __( 'Choosing shortcodes from the list and click "Save Changes" button, Porto will re-generate Visual Composer\'s css files by removing the unncessary shortcodes\' styles that you have chosen.', 'porto' ),
                        'multi' => true,
                        'options' => array(
                            '' => ''
                        ),
                        'required' => array( 'speed-optimize-js-composer', 'equals', true ),
                    ),
                    array(
                    ...
                    array(
                        ...
                        'desc' => __( 'By using this option, revolution slider\'s resources will be loaded for the certain pages that you choose. This will reduce around 200KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
...
if ( !function_exists( 'porto_render_vc_shortcodes_options' ) ) {
    function porto_render_vc_shortcodes_options( $_render, $field ) {
        if ( isset( $field['id'] ) && 'speed-optimize-js-composer-shortcodes' == $field['id'] && class_exists( 'WPBMap' ) ) {
            $all_shortcodes = WPBMap::getAllShortCodes();
            $all_categories = WPBMap::getCategories();
            ...
            if ( !empty( $all_shortcodes ) ) {
                ...
                foreach( $all_categories as $c ) {
                    ...
                    $options_html .= '<optgroup label="'. esc_html( $c ) .'">';
                    foreach( $all_shortcodes as $key => $s ) {
                        if ( $s['category'] === $c || ( is_array( $s['category'] ) && in_array( $c, $s['category'] ) ) ) {
                            if ( $key == 'vc_row' || $key == 'vc_row_inner' || $key == 'vc_column' || $key == 'vc_column_inner' || strpos( $key, 'porto_' ) === 0 ) {
                                continue;
                            }
                            $options_html .= '<option value="'. $key .'"'. ( isset( $porto_settings['speed-optimize-js-composer-shortcodes'] ) && is_array( $porto_settings['speed-optimize-js-composer-shortcodes'] ) && in_array( $key, $porto_settings['speed-optimize-js-composer-shortcodes'] ) ? ' selected="selected"' : '' ) .'>'. $s['name'] .'</option>';
                        }
                    }
                    $options_html .= '</optgroup>';
                }
            }
            $_render = preg_replace( '#(<select[^>]*>)(.*)(</select>)#is', '$1'.$options_html.'$3', $_render );
        }
        return $_render;
    }
}
add_filter( 'redux/field/porto_settings/select/render/after', 'porto_render_vc_shortcodes_options', 10, 2 );