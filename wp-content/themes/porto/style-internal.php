...
if ( isset( $porto_product_layout ) && $porto_product_layout ) : ?>
    ...
    <?php elseif ( 'extended' === $porto_product_layout ) : ?>
        ...
        .product-layout-extended .entry-summary .quantity:before { content: 'QTY:'; font-size: 15px; font-weight: 600; color: #21293c; line-height: 24px; }
        .product-layout-extended .product-summary-wrap .summary-before { margin-bottom: 2em; }
        .product-layout-extended .woocommerce-variation.single_variation { margin-top: 15px; }
    ...
    <?php elseif ( 'full_width' === $porto_product_layout ) : ?>
        ...
        .single-product .sticky-active .product-thumbnails { <?php echo $left; ?>: <?php echo 30 - $porto_settings['grid-gutter-width'] / 2; ?>px; }
        ...
        @media (max-width: 1679px) {
            .single-product .product-thumbnails { top: 20px; }
    ...
    <?php elseif ( 'sticky_both_info' === $porto_product_layout ) : ?>
        ...
        .single_add_to_cart_button { margin-<?php echo $right; ?>: 0; }
        .single-product .variations { width: 100%; }
        .single-product .variations tr { border-bottom: 1px solid #dae2e6; }
        .single-product .variations .label { width: 75px; }
        .variations tr td { padding-top: 15px; padding-bottom: 15px; }
    ...
    <?php elseif ( 'left_sidebar' === $porto_product_layout ) : ?>
        ...
        .product-layout-left_sidebar .variations:after { content: ''; position: absolute; border-top: 1px solid #ebebeb; }
        .product-layout-left_sidebar .variations tr:last-child td { padding-bottom: 20px; }
    <?php endif;
endif;
