...
<div class="landing">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Choose your favourite payment method to pay vendors','yith_wc_product_vendors');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Set a default payment method for your vendors’ commissions. Choose one among the available gateways to pay your vendors automatically.','yith_wc_product_vendors'),'<b>','</b>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('CSV export of the reports','yith_wc_product_vendors');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Display vendor\'s name','yith_wc_product_vendors');?></h2>
                </div>
                <p>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_WPV_URL ?>assets/images/44-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WPV_URL ?>assets/images/44-icon.png" alt="Icon"/>
                    <h2><?php _e('Enable shipping for vendors','yith_wc_product_vendors');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'Thanks to the shipping module, you can %1$slet vendors manage shipping costs%2$s for their own products. ','yith_wc_product_vendors' ),'<b>','</b>');?>
                </p>
                <p>
                    <?php _e( 'Vendors can create shipping zones and apply the related costs directly from their dashboard.','yith_wc_product_vendors' )?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_WPV_URL ?>assets/images/44.png" alt="Screenshot"/>
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_WPV_URL ?>assets/images/45-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WPV_URL ?>assets/images/45.png" alt="Screenshot"/>
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WPV_URL ?>assets/images/45-icon.png" alt="icon"/>
                    <h2><?php _e('Shipping Info','yith_wc_product_vendors');?></h2>
                </div>
                <p>
                    <?php _e( 'Each vendor can insert information related to his/her shipping costs and processing that users can view on the product detail page.','yith_wc_product_vendors' )?>
                </p>
            </div>
        </div>
    </div>
    <div class="section section-odd clear" style="background: url(<?php echo YITH_WPV_URL ?>assets/images/49-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WPV_URL ?>assets/images/49-icon.png" alt="Icon"/>
                    <h2><?php _e('Pay vendors\' commissions through Stripe Connect','yith_wc_product_vendors');?></h2>
                </div>
                <p>
                    <?php _e( 'Thanks to the integration with YITH Stripe Connect for WooCommerce you will be able to <b>have payments split between you and the vendors on checkout page</b>. Remove any possibility to make mistakes with manual payments and save a lot of time and trouble!','yith_wc_product_vendors' );?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_WPV_URL ?>assets/images/49.png" alt="Screenshot"/>
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_WPV_URL ?>assets/images/50-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WPV_URL ?>assets/images/50.png" alt="Screenshot"/>
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WPV_URL ?>assets/images/50-icon.png" alt="icon"/>
                    <h2><?php _e('Handle Privacy Policy and data cancellation','yith_wc_product_vendors');?></h2>
                </div>
                <p>
                    <?php _e( 'Now you can choose which information of a vendor account have to be deleted when your users ask for an account cancellation. Delete just vendor profile information or also vendor profile media and commission user IDs in commissions. Moreover, you can add vendor commissions to the export file as well.','yith_wc_product_vendors' )?>
                </p>
            </div>
        </div>
    </div>
