...
! defined( 'YITH_WPV_VERSION' )         && define( 'YITH_WPV_VERSION', '3.2.3' );
! defined( 'YITH_WPV_DB_VERSION' )      && define( 'YITH_WPV_DB_VERSION', '1.1.12' );
