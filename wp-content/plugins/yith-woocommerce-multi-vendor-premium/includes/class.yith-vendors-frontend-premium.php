        ...
        public function add_store_page_header() {
            if ( $this->is_vendor_page() ) {
	            ...
	            $args = apply_filters( 'yith_wcmv_store_header_template_arg', array(
			            ...
			            'header_image'            => $header_image_func( $vendor->header_image, apply_filters( 'yith_wcmv_get_header_size', YITH_Vendors()->get_image_size( 'header' ) ), false, $header_img_class ),
			            'hedaer_image_html'       => $hmtl_header_image_format,
