...
if ( ! class_exists( 'YITH_Vendors_Admin_Premium' ) ) {
    ...
    class YITH_Vendors_Admin_Premium extends YITH_Vendors_Admin {
        ...
        public function __construct() {
	        ...
	        add_filter( 'login_redirect', 'YITH_Vendors_Admin_Premium::switch_back_redirection_url', 10, 3 );
        }
        ...
        */
	     ...
	     */
	    public static function switch_back_redirection_url( $redirect_to, $requested_redirect_to, $new_user ) {
		    global $user_switching;
